...
root.dir <- "/Volumes/im-lab/nas40t2/jason/projects/MetaXcan/results/meta-analyses/"
diag.dir <- "/Volumes/im-lab/nas40t2/jason/projects/MetaXcan/results/DIAGRAM3_ImpG_0.80/"
...
res.dir <- root.dir %&% "DIAGRAM-GERA_ImpG_0.80/alpha_1_predictFDR0.05/"
file.vec <- list.files(res.dir,pattern="TW")
file.vec <- append(file.vec,list.files(res.dir,pattern="CrossTissue"))
bonfer.genes <- unique(get.bonfer.genes(file.vec,"1_predictFDR0.05"))
fdr.genes <- unique(get.fdr.genes(file.vec,"1_predictFDR0.05"))
make.partition.plot(1)
```
