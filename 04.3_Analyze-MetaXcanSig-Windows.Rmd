...
write.table(genemods.df,file="/Volumes/im-lab/nas40t2/jason/projects/MetaXcan/results/predictors/by_locus/gtexV6p/genemods.txt",sep="\t",quote = FALSE,row.names=FALSE)
