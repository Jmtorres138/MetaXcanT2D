...
```{r diag3, echo=FALSE}
rds.root.dir <- "/Users/jtorres/Google Drive/Projects/MetaXcan/MetaXcanT2D/RDS/"
...
res.dir <- root.dir %&% "DIAGRAM3_ImpG_0.80/alpha_1_predictFDR0.05/"
...
res.dir <- root.dir %&% "GERA-T2D_ImpG_0.80/alpha_1_predictFDR0.05/"
file.vec <- list.files(res.dir,pattern="TW")
file.vec <- append(file.vec,list.files(res.dir,pattern="CrossTissue"))
bonfer.genes <- unique(get.bonfer.genes(file.vec))
fdr.genes <- unique(get.fdr.genes(file.vec))
