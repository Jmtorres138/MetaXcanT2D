---
title: "01.3_GetSigGenes-GERA-Rep.Rmd"
author: "Jason Torres"
date: "August 4, 2016"
output:
  pdf_document:
...
make_rep_df <- function(){
  ...
  p.df <- cbind(select(p.L.df,one_of("Gene","CrossTissue")),select(p.L.df,contains("TW_")))
  z.df <- cbind(select(z.L.df,one_of("Gene","CrossTissue")),select(z.L.df,contains("TW_")))
  n.L.df <- readRDS(rds.dir %&% "gera/n.L.df.RDS")
  n.df <- cbind(select(n.L.df,one_of("Gene","CrossTissue")),select(n.L.df,contains("TW_")))
