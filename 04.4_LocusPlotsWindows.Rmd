...
#  8  9 18 21 28 30 32 41 42
locus_6array_plot_upper(c(8,9,18,21,28,30),"GROUP1.part1",set.letter = "")
locus_6array_plot_upper(c(32,41,42),"GROUP1.part2",set.letter = "")

# group 2
filter(msig.loci.df,group==2)$locus
# 1  3  6 13 31 33 35 40
locus_6array_plot_upper(c(1,3,6,13,31,33),"GROUP2.part1",set.letter = "")
locus_6array_plot_upper(c(35,40),"GROUP2.part2",set.letter = "")

# group 3
filter(msig.loci.df,group==3)$locus
# 15 24 26
locus_6array_plot_upper(c(15,24,26),"GROUP3.part1",set.letter = "")

# group 4
filter(msig.loci.df,group==4)$locus
# 16 17 20 22 27 34 38 46
locus_6array_plot_upper(c(16,17,20,22,27,34),"GROUP4.part1",set.letter = "")
locus_6array_plot_upper(c(38,46),"GROUP4.part2",set.letter = "")
