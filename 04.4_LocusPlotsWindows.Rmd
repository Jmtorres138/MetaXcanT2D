...
locus.subset <- function(locnum){
  ...
  df <- select(df,nearby.gene:Whole.Blood.DGN); names(df) <- gsub("TW_","",names(df))
...
# 9 18 21 28 30 32 41 42
locus_6array_plot_upper(c(9,18,21,28,30,32),"GROUP1.part1",set.letter = "")
locus_6array_plot_upper(c(41,42),"GROUP1.part2",set.letter = "")

# group 2
filter(msig.loci.df,group==2)$locus
# 1  4 13 14 15 16 20 31 33 35
locus_6array_plot_upper(c(1,4,13,14,15,16),"GROUP2.part1",set.letter = "")
locus_6array_plot_upper(c(20,31,33,35),"GROUP2.part2",set.letter = "")

# group 3
filter(msig.loci.df,group==3)$locus
# 8 10 22 26
locus_6array_plot_upper(c(8,10,22,26),"GROUP3.part1",set.letter = "")

# group 4
filter(msig.loci.df,group==4)$locus
# 2  5  7 12 17 23 24 27 34 38 40 46 47
locus_6array_plot_upper(c(2,5,7,12,17,23),"GROUP4.part1",set.letter = "")
locus_6array_plot_upper(c(24,27,34,38,40,46),"GROUP4.part2",set.letter = "")
locus_6array_plot_upper(c(47),"GROUP4.part3",set.letter = "")
